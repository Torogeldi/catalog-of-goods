...
<?php
        ...
        $result = mysql_query("SELECT * FROM table_products WHERE visible='1' $query_brand $query_price ORDER BY product_id DESC",$link);
    ...
    ';
        ...
        {
           echo '<h3>Категория не создано или не доступна!</h3>';
        }
?>
</ul> 
